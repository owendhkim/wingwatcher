...
import onetoone.Birdtrackinginfos.BirdtrackinginfoRepository;
...
class Main {
     ...
     */
    @Bean
    CommandLineRunner initUser(UserRepository userRepository, LaptopRepository laptopRepository, BirdtrackinginfoRepository birdtrackinginfoRepository) {
        return args -> {
            ...
            Birdtrackinginfo birdtrackinginfo1 = new Birdtrackinginfo( 42.02816817640385, -93.64974027935308, "10/02/2023","12:00", "http://somelink" );
            birdtrackinginfoRepository.save(birdtrackinginfo1);
